...
public interface ICmsRepository
{
    ...
    Task<IReadOnlyList<DistrictTrainingRecord>> GetDistrictTrainingRecordsAsync(CancellationToken cancellationToken = default);
    Task<DistrictTrainingRecord?> GetDistrictTrainingRecordAsync(int id, CancellationToken cancellationToken = default);
    Task<DistrictTrainingRecord?> GetDistrictTrainingRecordByDistrictAsync(string district, CancellationToken cancellationToken = default);
    Task<int> CountDistrictTrainingRecordsAsync(CancellationToken cancellationToken = default);
    Task<DistrictTrainingRecord?> UpsertDistrictTrainingRecordAsync(DistrictTrainingRecord record, CancellationToken cancellationToken = default);
    Task<bool> UpdateDistrictTrainingRecordAsync(DistrictTrainingRecord record, CancellationToken cancellationToken = default);
    Task<bool> DeleteDistrictTrainingRecordAsync(int id, CancellationToken cancellationToken = default);
    ...
    Task<CancerBurdenRecord?> GetCancerBurdenRecordByDistrictAsync(string district, CancellationToken cancellationToken = default);
    Task<int> CountCancerBurdenRecordsAsync(CancellationToken cancellationToken = default);
    Task<CancerBurdenRecord?> UpsertCancerBurdenRecordAsync(CancerBurdenRecord record, CancellationToken cancellationToken = default);
